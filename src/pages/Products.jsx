...
function Products() {
  ...
  return (
    <div className="flex flex-col gap-4 border-b-slate-400">

       {/* Products Filter Section */}
      <ProductsFilter />
      
      {/* TITLE */}
      <h1 className="mt-2 text-xl sm:text-4xl text-secondary w-[90%] pb-2  border-b-2">
